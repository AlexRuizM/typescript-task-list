...
export class App {
  ...
  input: HTMLInputElement | null; // HTMLInputElement: la interfaz para elementos <input>.
  arrow: HTMLElement | null;
  table: HTMLTableElement | null; // HTMLTableElement: la interfaz para elementos <table>.
...
<td>
  ...
  `;
    ...
    newRow.firstElementChild.nextElementSibling.firstElementChild.lastElementChild.addEventListener(
      "click",
      (event: MouseEvent) => {
        this.editModeOn(event: MouseEvent, false);
      }
    );
    //Eliminar la fila
